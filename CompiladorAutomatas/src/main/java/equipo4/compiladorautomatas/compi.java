...
public class compi {
    ...
    int matriz[][] = {
        ...
        /*11*/  {505, 505,    505,      505,    505,    505,    505,    505,    505,    505,    113,    505,    505,    505,    505,    505,    505,    505,    505,    116,    116,    116,    116,    116,    116,    116,    116},
        /*12*/  {505, 505,    505,      505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505},
        /*13*/  {505, 505,    505,      505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505,    505},
            ...
            if(id.startsWith("(")){
                for(int j=1;j<(operacion.size());j++){
                    ...
                    if(operacion.get(j).charAt(0)=='0'||operacion.get(j).charAt(0)=='1'||operacion.get(j).equals("2")
                            ...
                            ||operacion.get(j).charAt(0)=='9'||operacion.get(j).charAt(0)=='-'){
                        ...
                        for(int k = 0;k<tabla.size();){
                            ...
                            if(operacion.get(j).equals(tabla.get(k).ide)){
                                ...
                                if(k!=tabla.size()){
                                    ...
                                    System.out.println("Error 526: Problemas con ID's. Renglon: " + p.renglon);
                                    System.exit(0);
                                }
                            }
                        }
